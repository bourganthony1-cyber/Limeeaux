    ...
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ fontWeight: 800, fontSize: "1.125rem", letterSpacing: "-0.5px" }}>Lumiere</span>
        </div>
        ...
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          <div style={{ maxWidth: 680 }} className="animate-in">
            ...
            <p style={{ fontSize: "1.125rem", marginBottom: 40, maxWidth: 520, lineHeight: 1.7 }}>
              Lumiere connects riders with top-rated drivers in seconds. Safe, affordable, and always on time.
            </p>
      ...
      <section style={{ padding: "80px 40px" }}>
        <div className="container">
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            <h2>Why riders choose <span className="gradient-text">Lumiere</span></h2>
      ...
      <footer style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, fontWeight: 700, color: "var(--text-primary)" }}>
          <Car size={16} color="var(--accent-blue)" /> Lumiere
        </div>
        <div>© 2026 Lumiere. All rights reserved.</div>
      </footer>
    </div>
  );
}
